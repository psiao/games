// ===========================================================================
// mod/skwibble.js — skwibble as an SPA module (mount/unmount). Same Firebase model.
// ===========================================================================
// ===========================================================================
...
const Sound = {
  ...
  correct() { Audio.sfx("correct"); },
  mine() { Audio.sfx("tap"); },
  tick() { Audio.sfx("tick"); },
  turnStart() { Audio.sfx("round"); },
  gameEnd() { Audio.celebrate(); },
};
...
const SCREENS = `
  ...
  <section id="screen-join" class="screen active">
    <div class="wrap">
      <div class="brandbar">
        ...
        <div>
          <h1>Skwibble</h1>
          <p class="tagline">A Legal Soft game</p>
        </div>
      </div>
      <div class="card">
        <div class="field">
        ...
        <div class="field">
          ...
          <div class="row">
            ...
            <select id="opt-role" title="Join as" style="flex:0 0 auto">
          ...
          <p class="hint">Players draw &amp; score. Observers just watch and chat.</p>
        </div>

        <div class="divider">or</div>

        <div class="field">
          <label>Host a new game</label>
          <div class="row">
            <select id="opt-rounds" title="Rounds">
              <option value="1">1 round</option>
              <option value="2">2 rounds</option>
              <option value="3" selected>3 rounds</option>
            </select>
            <select id="opt-time" title="Seconds per turn">
              <option value="60">60s</option>
              <option value="80" selected>80s</option>
              <option value="100">100s</option>
            </select>
            <select id="opt-diff" title="Difficulty">
              <option value="1">Level 1 · Easiest</option>
              <option value="2" selected>Level 2 · Easy</option>
  ...
  <section id="screen-lobby" class="screen">
    <div class="wrap">
      <div class="brandbar">
        <div class="logo">LS</div>
        <div><h1>Skwibble</h1><p class="tagline">Lobby</p></div>
      </div>
      <div class="card">
        ...
        <div class="listhead">
          ...
          <span class="count" id="lobby-count"></span>
        </div>
  ...
  <section id="screen-game" class="screen">
    <div class="game-shell">
      <div class="topbar">
        <div class="tb-left">
          <div class="logo sm">LS</div>
          <div class="round" id="game-round">Round 1</div>
        </div>
        <div class="word" id="game-word"></div>
        <div class="tb-right">
      ...
      <div class="game-grid">
        <div class="canvas-wrap">
          ...
          <div class="toolbar hidden" id="toolbar">
            <span id="swatches" class="swatches"></span>
            <span class="tools">
              <button id="tool-pen" class="tool-btn sel" title="Pen" type="button">✏️</button>
              <button id="tool-fill" class="tool-btn" title="Fill area" type="button">🪣</button>
            </span>
        ...
        <div class="side">
          <div class="panel">
            <div class="panel-head"><h3>Scores</h3>
              <span class="legend"><span class="dot"></span>online <span class="dot off"></span>offline</span>
            </div>
            <ul class="scores" id="game-scores"></ul>
            <div id="game-observers" class="observers" style="display:none">
              <h4>👁 Observers</h4>
          ...
          <div class="panel">
            ...
            <div class="chat">
              ...
              <div class="chatform">
                ...
                <button id="guess-send" class="btn-primary">Send</button>
              </div>
            </div>
          </div>
...
// AUTH
// ---------------------------------------------------------------------------
authUnsub = onAuthStateChanged(auth, (user) => { if (user) { ME = user.uid; offerRejoin(); } });
...
$("btn-copy").addEventListener("click", async () => {
  const url = `${location.origin}${location.pathname}#/skwibble?room=${ROOM}`;
...
$("btn-leave").addEventListener("click", async () => { try { if (ROOM && ME) await update(ref(db, `rooms/${ROOM}/players/${ME}`), { connected: false }); } catch {} __shell.goHome(); });
...
export function unmount() {
  ...
  _detach(); _stop();
  Music.stop();
  document.getElementById("skwibble-css")?.remove();
}
